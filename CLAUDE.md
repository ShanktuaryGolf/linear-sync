...
The `scripts/linear-sync.sh` script depends on [Gas Town](https://github.com/anthropics/gas-town) for agent dispatch and lifecycle management. The Discord bot (`bot/`) does **not** require Gas Town — it only talks to Discord and Linear.
